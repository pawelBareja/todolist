...
class App extends Component {
  ...
  state = {
    ...
    { id: 1, text: "zrobić dobry uczynej", date: '2020-11-12', important: false, active: false, finishDate: null },
  ...
  render() {
    return (
      <div>
        <TaskList tasks={this.state.tasks} markTaskDone={this.markTaskDone} deleteTask={this.deleteTask} />
      </div>
    );
  }
}
